...
class KNN:
    def __init__(self, train_data, labels, distance_metric='euclidean'):
        ...
        self.distance_metric = distance_metric  # 'euclidean' or 'manhattan'
    ...
    def get_k_neighbours(self, test_data, k):
        """
        Given test_data, calculates the k nearest neighbours using the selected distance metric.
        ...
        Result:
            self.neighbors: NxK matrix of the labels of the k nearest neighbors
        """
        ...
        # Use selected metric: 'euclidean' or 'cityblock' (Manhattan)
        metric = 'cityblock' if self.distance_metric == 'manhattan' else 'euclidean'
        distances = cdist(test_data_flat, self.train_data, metric=metric)
